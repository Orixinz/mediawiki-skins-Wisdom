...
### Installation
1. [https://github.com/Orixinz/mediawiki-skins-Wisdom/releases/latest](Download) the latest release of the skin and place the files in a *Wisdom* directory in your *Skins* folder.
